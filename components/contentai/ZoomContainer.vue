<template>
    ...
    >
      ...
      <button v-if="isTransformed" @click="resetTransform" class="reset-button bg-white py-2 px-2 rounded-md text-purple-dark text-psmall border border-white hover:border-purple-dark transition-all">Reset</button>
    </div>
  </template>
