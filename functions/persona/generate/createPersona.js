...
const openai = new OpenAI({
  apiKey: functions.config().openai.apikey, // Add your OpenAI API key to Firebase functions environment
});
...
// Cloud Function to gather data, generate JSON, and store it in Firestore
export const createPersona = functions.https.onRequest(async (req, res) => {
  ...
  corsHandler(req, res, async () => {
    ...
    try {
      const { userId, websiteSummary, postsSummary } = req.body;
      ...
      //     "contentPreferences": ["string", "string", "string", "string"],
      //     "demographics": {
      //       "ageRange": ["string", "string", "string", "string"],
      //       "behaviors": ["string", "string", "string", "string"],
      //       "gender": ["string", "string"],
      //       "geographicalLocations": ["string", "string"],
      ...
      //   },
      //   "brandAnalysis": {
      //     "coreOfferings": ["string", "string", "string", "string"],
      //     "swot": {
      ...
      //   }
      // }
      // If data for any field is insufficient, infer the most accurate values based on the website summary and posts.`;

      // User prompt to provide summaries for the AI to analyze
      const systemPrompt = `You are an assistant that generates structured JSON data for digital marketing analysis.
