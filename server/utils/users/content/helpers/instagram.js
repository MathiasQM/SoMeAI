...
export async function formatForInstagram(persona, personaDescription, userInput) {
  ...
  let systemPrompt = `You are a marketing/Social Media and content expert that specializes in creating engageing marketing/SoMe content for Instagram aimed at engageing the target audeience, in structured json data. The structure should include:
    ...
    Focus on the points made here: ${userSuppliedPostsDescription}.
    
    This is a description of what characterizes posts that have had the best engagement: ${systemSelectedPostDescription}.

    Use the descriptions above to influence the tone, writing style, jargon, format, structure, point of view, emoji use, use of anecdoes and more of the post that you will create.
